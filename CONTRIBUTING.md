# Contributing to harmony-flow

Thank you for contributing to the Harmony Vector Flow Service!
...
The easiest way to get help or ask a question regarding harmony-flow is in the JPL Slack #podaac-tva channel, filing an [issue](https://github.com/jackiryan/harmony-flow/issues), or by asking a question on the [PO.DAAC Forum](https://forum.earthdata.nasa.gov/viewforum.php?f=7&tagMatch=all&DAAC=146&keywords=&).
...
of harmony-flow that produced this bug and specific error messages.
...
The `harmony-flow` module follows PEP8 as much as possible. Reference the [pylint](.pylintrc)
and [flake8](.flake8) configuration files for specific expectations. The CI/CD pipeline
will fail unless there are 0 flake8 warnings and anything other than a 10/10 pylint score.

Please keep any Harmony or CMR-specific code out of the actual code. The `harmony-flow`
module should be able to run locally without any reliance on outside services.
